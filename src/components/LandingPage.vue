              ...
              <div class="p-6 border-b border-sunset-100/20">
                <div class="flex items-start mb-4">
                  <div class="rounded-lg p-2 bg-sunset-100/20 text-sunset-400 mr-4 transition-colors group-hover:bg-sunset-100/40">
                    ...
                    <svg v-else-if="mode.id === 'flag'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18m0-18h13l-3 5 3 5H3" />
                    </svg>
